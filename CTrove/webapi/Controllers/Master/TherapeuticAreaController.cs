...
namespace CTrove.Api.Controllers.Master
{
    ...
    [ApiController]
    [Authorize]
    public class TherapeuticAreaController : ControllerBase
    {
        private readonly ITherapeuticAreaServices _services;
        private readonly AuthService _authService;
        public TherapeuticAreaController(ITherapeuticAreaServices services, AuthService auth)
        {
            _services = services;
            _authService = auth;
        }
    ...
    //    [CtroveAuthorize(new string[] { CtroveRoles.Admin })]
       ...
       // [CtroveAuthorize(new string[] { CtroveRoles.Admin })]
        ...
        {
            var result = await _services.Delete(req, _authService.GetUserObjectId());
